...
export const metadata: Metadata = {
  title: "Gabo Dev | Desarrollador Full Stack",
  description: "Portfolio de Gabo Dev - Desarrollador Full Stack especializado en React, Next.js, Node.js y tecnologías modernas. Transformando ideas en experiencias digitales excepcionales.",
  keywords: "desarrollador full stack, react, next.js, typescript, node.js, portfolio",
  authors: [{ name: "Gabo Dev" }],
  openGraph: {
    title: "Gabo Dev | Desarrollador Full Stack",
...
export default function RootLayout({
  ...
  return (
    <html lang="es" className="scroll-smooth">
      <head>
        <link rel="icon" href="https://gabo-dev.vercel.app/favicon.ico" />
      </head>
      <body
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div>
                ...
                <div className="space-y-2">
                  <a href="#about" className="block text-slate-400 hover:text-cyan-400 transition-colors text-sm">
                    Sobre mí
                  </a>
              ...
              <div>
                ...
                <div className="flex space-x-4">
                  ...
                  <a 
                    href="mailto:contacto@gabodev.com"
                    className="w-10 h-10 bg-slate-800 hover:bg-slate-700 rounded-lg flex items-center justify-center transition-colors"
                  >
