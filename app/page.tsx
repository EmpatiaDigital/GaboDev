      ...
      <section id="contacto" className="py-24 px-4 relative">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-gradient-to-br from-slate-800/50 to-slate-900/50 p-10 rounded-3xl border border-indigo-500/30 shadow-2xl backdrop-blur-xl animate-fadeInUp animation-delay-300">
            ...
            <div className="mt-10 pt-10 border-t border-indigo-500/30">
              <p className="text-center text-gray-400 mb-6">También puedes contactarme por WhatsApp</p>
              <div className="flex justify-center">
                <a
                  href="https://wa.me/543462529718"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="group px-8 py-4 bg-green-600 hover:bg-green-700 rounded-2xl transition-all border border-green-500/50 hover:scale-105 backdrop-blur-sm flex items-center gap-3 shadow-lg hover:shadow-green-500/50"
                  onMouseEnter={() => setCursorVariant('link')}
                  onMouseLeave={() => setCursorVariant('default')}
                >
